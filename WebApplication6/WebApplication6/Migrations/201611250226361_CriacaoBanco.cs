namespace WebApplication6.Migrations
{
    ...
    public partial class CriacaoBanco : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Corrente = c.Single(nullable: false),
                        Objeto_IDObjeto = c.Int(),
                        Usuario_Id = c.String(maxLength: 128, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.IDMedida)
                .ForeignKey("dbo.Objetoes", t => t.Objeto_IDObjeto)
                ...
                c => new
                    {
                        ...
                        NomeObjeto = c.String(nullable: false, maxLength: 50, storeType: "nvarchar"),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Medidas", "Usuario_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Medidas", "Objeto_IDObjeto", "dbo.Objetoes");
            ...
            DropIndex("dbo.Medidas", new[] { "Usuario_Id" });
            DropIndex("dbo.Medidas", new[] { "Objeto_IDObjeto" });
